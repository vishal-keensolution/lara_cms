            ...
            <div class="card push-top">
                ...
                <?php endif; ?>
                    <form method="post" action="<?php echo e(route('users.store')); ?>" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-block btn-danger">Add User</button>
                    </form>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\lara_cms\resources\views/admin/adduser.blade.php ENDPATH**/ ?>