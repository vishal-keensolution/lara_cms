...
<form class="form-horizontal" action="{{ route('posts.update', $user->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    <div class="row">
        <div class="col-md-6">
...
<!--                         <input type="file" name="image" class="custom-file-input" id="exampleInputFile">
        ...
        <div class="col-md-6">
            <div class="card-body">
                <div class="form-group">
                    <label>Url</label>
                    <input type="text" value="{{$user->urls}}" class="form-control" name="urls"/>
                </div>
            </div>
        </div>
    </div>
               ...
               <!--  <div class="form-group">
                ...
                <!-- <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <textarea name="metadesc"  class="form-control" cols="50"  rows="3">{{$user->metadesc}}</textarea>
                </div>
            </div>
        </div>
        <div class="col-md-6">
