    ...
    <div class="card card-primary">
       <div class="card-header">
         ...
         @if ($errors->any())
          ...
          @endif
    <form class="form-horizontal" action="{{ route('category.update', $user->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" value="{{$user->description}}" name="" class="form-control">
              </div>
            </div>
          </div>
        </div>
      <div class="col-md-6">
        <div class="card card-secondary">
          <div class="card-body">
            ...
            <div class="form-group">
                <label for="inputClientCompany">Category for component</label>
                <input type="text" value="{{$user->cat_for_component}}" name="" class="form-control">
            </div>
          </div>
         </div>
      </div>
