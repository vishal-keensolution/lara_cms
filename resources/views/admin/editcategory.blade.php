...
<form action="{{ route('category.update', $user->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6">
            <div class="card-body">  
                <div class="form-group">
                    ...
                    <input type="text" value="{{$user->title}}" name="title" class="form-control" value="">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$user->alias}}" name="alias" class="form-control" value="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="form-group">
                   <label>Description</label>
                    <div class="controls">
                        <textarea name="description" cols="" rows="" style="width: 100%; height: 500px;" class="editable">{{$user->description}}</textarea>   
                    </div> 
                </div>
            </div>    
        </div>
            ...
            <div class="card-body">  
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{$user->metakey}}" class="form-control" name="metakey" />
                </div>
             <!--  <div class="form-group">
                    <label>Robots</label>
                    <select id="" class="form-control" name="">
        ...
        <div class="col-md-6">
            <div class="card-body"> 
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    <label>Author</label>
                    <input type="text" value="{{$user->metadata}}" class="form-control" name="metadata" />
                </div>
                <div class="form-group">
